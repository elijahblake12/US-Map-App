...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { device: @point.device, latitude: @point.latitude, longitude: @point.longitude, recorded_at: @point.recorded_at, zip_code: @point.zip_code } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { device: @point.device, latitude: @point.latitude, longitude: @point.longitude, recorded_at: @point.recorded_at, zip_code: @point.zip_code } }
